...
export default function RepositoryPage({
  ...
  const chartData = Object.entries(repository.commits).map(([user, total], index) => ({
    user,
    total: total ?? 0,
    fill: colors[index % colors.length],
  }));
  return (
    <div style={{ display: "flex", justifyContent: "center", color: "var(--color-foreground)" }}>
      <div style={{ width: "33%", textAlign: "left" }}>
        <h1 style={{ fontSize: "2em", fontWeight: "bold", color: "var(--color-primary)" }}>
